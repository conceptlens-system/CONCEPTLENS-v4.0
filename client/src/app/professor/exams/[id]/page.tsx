...
import { Plus, Trash2, Users, Upload, Copy, HelpCircle, Check, ChevronLeft, Search, ChevronsUpDown, X, Sparkles, Save, Trophy } from "lucide-react"
...
export default function EditExamPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        try {
            ...
            if (localDraft) {
                try {
                    ...
                    if (parsed.enableXp !== undefined) setEnableXp(parsed.enableXp)
                    else setEnableXp(examData.enable_xp !== false)
            ...
            setEnableXp(examData.enable_xp !== false)
    ...
    }, [title, selectedSubject, selectedClasses, duration, questions, startTime, accessEndTime, antiCheatConfig, enableXp, examId, loading, isLoaded])
        ...
        <div className="min-h-screen bg-slate-50/50 pb-20">
            ...
            <main className="flex-1 overflow-hidden flex flex-col max-w-[1000px] mx-auto w-full px-6 pt-6 pb-6">
                <Tabs defaultValue="manual" value={aiMode} onValueChange={setAiMode} className="flex flex-col h-full w-full">
                    ...
                    <TabsContent value="ai" className="flex-1 overflow-y-auto pb-12">
